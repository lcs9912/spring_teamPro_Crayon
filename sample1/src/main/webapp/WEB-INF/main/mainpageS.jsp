...
<head>
    ...
    <title>CrayoN 신발 페이지용 슬라이드</title>
    <style>
        ...
        .slide {
            ...
            height: 100%; background-position-y:25%;
...
<body>
    <div id="app">        
        <div class="slider-wrap">
            ...
            <div class="slider">
                <div class="slide" style="background-image: url('https://user-images.githubusercontent.com/137017779/263294065-22676707-6b40-4a4d-a9fe-be16101611c6.gif');">
                    <h1 class="innertext">
                        Limited Edition 경매로 입찰
                    </h1>
                </div>
                <div class="slide" style="background-image: url('https://user-images.githubusercontent.com/137017779/263513011-98622cc6-13df-465d-a299-41cac15ebdaf.jpg');">
                    <h1 class="innertext">
