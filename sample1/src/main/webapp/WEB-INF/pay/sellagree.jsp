	...
	<div class="contentsarea">
		<div style="box-shadow: 0 4px 10px 0 rgba(0,0,0,.1);">
			<div class="productcontents">
				...
				<span style="color:limegreen;">판매</span>하시기 전에 꼭 확인하세요.</h1>
			...
			<div class="productdetailagreearea">
				<div class="noticegroup">
					...
					<div class="checkarea">
						...
						<div class="noticecontents">상품 이미지, 모델번호, 출시일, 상품명, 사이즈를 한 번 더 확인했습니다.</div>
					</div>
				</div>
				...
				<div class="noticegroup">
					...
					<div class="checkarea">
						...
						<div class="noticecontents">모든 구성품이 그대로이며, 한 번도 착용하지 않은 정품・새상품입니다. 국내 발매 상품 여부는 확인드리지 않습니다.</div>
					</div>
				</div>
				...
				<div class="noticegroup">
					...
					<div class="checkarea">
						...
						<div class="noticecontents">반드시 이중 포장하여 택배 상자에 담아 선불 발송합니다. 합배송은 권장하지 않으며 이로 인한 박스/패키지 훼손은 판매자의 책임입니다.</div>
					</div>
				</div>
				
				<div class="noticegroup"  style="border:none;">
					<div class="noticeheader">CRAYON의 최신 이용정책을 모두 확인하였으며, 판매를 계속합니다.</div>
					<div class="checkarea">
				...
				<div class="continuebtn" style="width:100%; text-align:center;">
					<a @click="fnNowSell"><button :class="{ 'continuebtn-active': allCheck }" :disabled="!allCheck">판매 계속</button></a> <!-- orderandsettle.do 다음 링크 -->
				</div>
			</div>
		</div>
	</div>
