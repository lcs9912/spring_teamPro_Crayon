    ...
    <style>
    	* {margin: 0; padding: 0; box-sizing: border-box;}
        ...
        /*상품 품목별 전시영역 시작*/
	 	...
	 	.rankwrap {width:1200px; margin:0 auto; clear:both;}
    ...
    var headerAppMP = new Vue({
        ...
        methods: {
            ...
            fnGetList : function(){
                ...
                var nparmap = {cate1Num : self.maingate, kind : self.kind}
                  $.ajax({
                        url:"/shopmanPList.dox",
                        dataType:"json",
                        type : "POST",
                        data : nparmap,
                        success : function(data) {
            ...
            showMoreItems() {
                 ...
                 var objBtn = document.getElementById("dropdownbtnP");
                 var marginBtn = (this.visibleItemIndex / 4 * 540) + "px";
